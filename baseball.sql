...
SELECT DISTINCT playerid, namefirst AS firstname, namelast AS lastname, schoolname, COALESCE(SUM(salary), 0) AS total_salary
FROM people
...
-- David Price (priceda01) earned the most money with 245,553,888
